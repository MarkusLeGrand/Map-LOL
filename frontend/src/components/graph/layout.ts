...
export function calculate_circular_layout(index: number, total: number, center_x: number, center_y: number, radius: number): Position {
...
export function calculate_star_layout(nodes_count: number, canvas_width: number, canvas_height: number): Position[] {
