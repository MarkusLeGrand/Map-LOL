...
import { SPRING_STIFFNESS, DAMPING, REST_LENGTH, NODE_RADIUS, REPULSION_STRENGTH, REPULSION_DISTANCE } from './constants.js';
...
class PhysicsEngine
{
    ...
    apply_repulsion_force(node1, node2)
    {
        const dx = node2.x - node1.x;
        const dy = node2.y - node1.y;
    ...
    check_collision(node1, node2, collision_radius)
    {
        const dx = node2.x - node1.x;
        const dy = node2.y - node1.y;
